...
static void circuit(unsigned char inputs[64], unsigned char outputs[2]) {
    ...
    for (int sector = 0; sector < NUM_SECTORS; sector++) {
        ...
        unsigned char VAR_1_5_ROR_0 = VAR_IN_5 >> 0 ;
        ...
        unsigned char VAR_1_19_XOR = VAR_IN_14 ^ VAR_IN_0 ^ 0;
        unsigned char VAR_2_0_ADD = VAR_1_19_XOR + VAR_1_0_XOR + VAR_1_2_XOR + 0;
        unsigned char VAR_2_1_NAN = 0xff & ~  VAR_1_0_XOR & ~ VAR_1_1_XOR & ~ 0;
        ...
        unsigned char VAR_2_5_NOR = 0 | ~ VAR_1_5_ROR_0 | ~ VAR_1_6_XOR | ~ 0xff;
        unsigned char VAR_2_6_DIV = ((VAR_1_5_ROR_0 != 0) ? VAR_1_5_ROR_0 : 1) / ((VAR_1_7_XOR != 0) ? VAR_1_7_XOR : 1) / 1;
        ...
        unsigned char VAR_2_10_OR_ = VAR_1_9_XOR | VAR_1_11_XOR | VAR_1_12_XOR | 0;
        unsigned char VAR_2_11_NAN = 0xff & ~  VAR_1_11_XOR & ~ 0;
        unsigned char VAR_2_12_XOR = VAR_1_12_XOR ^ VAR_1_13_XOR ^ 0;
        unsigned char VAR_2_13_ADD = VAR_1_13_XOR + VAR_1_15_XOR + 0;
        ...
        unsigned char VAR_3_0_ADD = VAR_2_19_AND + VAR_2_1_NAN + 0;
        ...
        unsigned char VAR_3_9_AND = VAR_2_8_ROL_0 & VAR_2_10_OR_ & VAR_2_11_NAN & 0xff;
        unsigned char VAR_3_10_SUM = VAR_2_9_ROL_0 + VAR_2_10_OR_ + VAR_2_11_NAN + 0;
        ...
        unsigned char VAR_3_15_ADD = VAR_2_17_SUM + 0;
        unsigned char VAR_3_16_AND = VAR_2_15_MUL & VAR_2_17_SUM & 0xff;
        unsigned char VAR_3_17_MUL = VAR_2_16_NOP * 1;
        unsigned char VAR_3_18_ADD = VAR_2_19_AND + VAR_2_0_ADD + 0;
        unsigned char VAR_3_19_OR_ = VAR_2_18_XOR | VAR_2_0_ADD | VAR_2_1_NAN | 0;
        ...
        unsigned char VAR_4_3_ROR_2 = VAR_3_3_AND >> 2 ;
        ...
        unsigned char VAR_4_14_AND = VAR_3_15_ADD & VAR_3_16_AND & 0xff;
        unsigned char VAR_4_15_MUL = VAR_3_17_MUL * 1;
        ...
        unsigned char VAR_4_19_DIV = ((VAR_3_19_OR_ != 0) ? VAR_3_19_OR_ : 1) / ((VAR_3_1_SUB != 0) ? VAR_3_1_SUB : 1) / 1;
        unsigned char VAR_5_0_DIV = ((VAR_4_11_SUM != 0) ? VAR_4_11_SUM : 1) / ((VAR_4_14_AND != 0) ? VAR_4_14_AND : 1) / 1;
        unsigned char VAR_5_1_NOR = 0 | ~ VAR_4_14_AND | ~ VAR_4_15_MUL | ~ 0xff;
        unsigned char VAR_5_2_SUM = VAR_4_13_AND + VAR_4_14_AND + 0;
        unsigned char VAR_5_3_SUM = VAR_4_15_MUL + VAR_4_16_BSL_0 + VAR_4_17_ROL_0 + 0;
