...
/* Key setup */
void ECRYPT_Rabbit::ECRYPT_keysetup(void* ctxa, const u8* key, u32 keysize, u32 ivsize)
{
...
/* IV setup */
void ECRYPT_Rabbit::ECRYPT_ivsetup(void* ctxa, const u8* iv)
{
   RABBIT_ctx* ctx = (RABBIT_ctx*)ctxa;
   /* Temporary variables */
   u32 i0, i1, i2, i3, i;
...
void ECRYPT_Rabbit::RABBIT_process_bytes(int action, void* ctxa, const u8* input, 
...
void ECRYPT_Rabbit::RABBIT_process_blocks(int action, RABBIT_ctx* ctx, const u8* input, 
...
void ECRYPT_Rabbit::ECRYPT_encrypt_bytes(void* ctx, const u8 * plaintext, u8 * ciphertext, u32 msglen) {
	RABBIT_process_bytes(0, ctx, plaintext, ciphertext, msglen);
}
void ECRYPT_Rabbit::ECRYPT_decrypt_bytes(void* ctx, const u8 * ciphertext, u8 * plaintext, u32 msglen) {
