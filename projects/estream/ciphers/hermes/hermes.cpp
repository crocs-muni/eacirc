...
*/
void ECRYPT_Hermes::ECRYPT_keysetup(
  void* ctxa,
  const u8* key,
...
*/
void ECRYPT_Hermes::ECRYPT_ivsetup(
  void* ctxa,
  const u8* iv )
{
	HERMES_ctx* ctx = (HERMES_ctx*)ctxa;
...
*/
void ECRYPT_Hermes::HERMES_process_bytes(
  int action,
  void* ctxa, 
  const u8* input, 
  u8* output, 
...
/* ------------------------------------ end -------------------------------- */
void ECRYPT_Hermes::ECRYPT_encrypt_bytes(void* ctx, const u8 * plaintext, u8 * ciphertext, u32 msglen) {
	HERMES_process_bytes(0, ctx, plaintext, ciphertext, msglen);
}
void ECRYPT_Hermes::ECRYPT_decrypt_bytes(void* ctx, const u8 * ciphertext, u8 * plaintext, u32 msglen) {
	HERMES_process_bytes(1, ctx, ciphertext, plaintext, msglen);
}