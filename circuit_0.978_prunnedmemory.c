...
static void circuit(unsigned char inputs[64], unsigned char outputs[2]) {
    ...
    for (int sector = 0; sector < NUM_SECTORS; sector++) {
        ...
        unsigned char VAR_1_17_OR_ = VAR_IN_14 | VAR_IN_17 | VAR_IN_7 | 0;
        unsigned char VAR_1_18_ROL_6 = VAR_IN_18 << 6 ;
        unsigned char VAR_2_16_OR_ = VAR_1_16_XOR | VAR_1_17_OR_ | VAR_1_18_ROL_6 | 0;
        ...
        unsigned char VAR_5_4_SUM = VAR_4_18_AND + 0;
