...
static void circuit(unsigned char inputs[64], unsigned char outputs[2]) {
    ...
    for (int sector = 0; sector < NUM_SECTORS; sector++) {
        ...
        unsigned char VAR_2_16_NOR = 0 | ~ VAR_1_17_XOR | ~ VAR_1_18_XOR | ~ 0xff;
        unsigned char VAR_3_17_SUB = VAR_2_16_NOR - 0;
        ...
        unsigned char VAR_5_3_SUM = VAR_4_15_MUL + VAR_4_16_MUL + 0;
