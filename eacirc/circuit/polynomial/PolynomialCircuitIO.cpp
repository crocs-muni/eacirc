...
TiXmlElement* PolyIO::populationHeader_static(int populationSize) {
    ...
    pElem2->LinkEndChild(new TiXmlText(CommonFnc::toString(pGlobals->settings->polyCircuit.numPolynomials).c_str()));
    pElem->LinkEndChild(pElem2);
    pElem2 = new TiXmlElement("polydist_max_terms");
    pElem2->LinkEndChild(new TiXmlText(CommonFnc::toString(pGlobals->settings->polyCircuit.maxNumTerms).c_str()));
    pElem->LinkEndChild(pElem2);
    pElem2 = new TiXmlElement("polydist_term_count_p");
    pElem2->LinkEndChild(new TiXmlText(CommonFnc::toString(pGlobals->settings->polyCircuit.genomeInitTermCountProbability).c_str()));
    pElem->LinkEndChild(pElem2);
    pElem2 = new TiXmlElement("polydist_term_size_p");
    pElem2->LinkEndChild(new TiXmlText(CommonFnc::toString(pGlobals->settings->polyCircuit.genomeInitTermStopProbability).c_str()));
    pElem->LinkEndChild(pElem2);
    pElem2 = new TiXmlElement("polydist_mutate_term_strategy");
    pElem2->LinkEndChild(new TiXmlText(CommonFnc::toString(pGlobals->settings->polyCircuit.mutateTermStrategy).c_str()));
    pElem->LinkEndChild(pElem2);
    pElem2 = new TiXmlElement("polydist_mutate_add_term_p");
    pElem2->LinkEndChild(new TiXmlText(CommonFnc::toString(pGlobals->settings->polyCircuit.mutateAddTermProbability).c_str()));
    pElem->LinkEndChild(pElem2);
    pElem2 = new TiXmlElement("polydist_mutate_add_term_strategy");
    pElem2->LinkEndChild(new TiXmlText(CommonFnc::toString(pGlobals->settings->polyCircuit.mutateAddTermStrategy).c_str()));
    pElem->LinkEndChild(pElem2);
    pElem2 = new TiXmlElement("polydist_mutate_remove_term_p");
    pElem2->LinkEndChild(new TiXmlText(CommonFnc::toString(pGlobals->settings->polyCircuit.mutateRemoveTermProbability).c_str()));
    pElem->LinkEndChild(pElem2);
    pElem2 = new TiXmlElement("polydist_mutate_remove_term_strategy");
    pElem2->LinkEndChild(new TiXmlText(CommonFnc::toString(pGlobals->settings->polyCircuit.mutateRemoveTermStrategy).c_str()));
    pElem->LinkEndChild(pElem2);
    pElem2 = new TiXmlElement("polydist_crossover_randomize_poly");
    pElem2->LinkEndChild(new TiXmlText(CommonFnc::toString(pGlobals->settings->polyCircuit.crossoverRandomizePolySelect).c_str()));
    pElem->LinkEndChild(pElem2);
    pElem2 = new TiXmlElement("polydist_crossover_terms_p");
    pElem2->LinkEndChild(new TiXmlText(CommonFnc::toString(pGlobals->settings->polyCircuit.crossoverTermsProbability).c_str()));
    pElem->LinkEndChild(pElem2);
    pRoot->LinkEndChild(pElem);
    return pRoot;
}
