...
static void circuit(unsigned char inputs[64], unsigned char outputs[2]) {
    ...
    for (int sector = 0; sector < NUM_SECTORS; sector++) {
        ...
        unsigned char VAR_1_17_SUM = VAR_IN_17 + 0;
        unsigned char VAR_1_18_XOR = VAR_IN_18 ^ 0;
        unsigned char VAR_2_16_OR_ = VAR_1_16_XOR | VAR_1_17_SUM | VAR_1_18_XOR | 0;
        unsigned char VAR_3_17_ROL_0 = VAR_2_16_OR_ << 0 ;
        unsigned char VAR_4_15_MUL = VAR_3_17_ROL_0 * 1;
        unsigned char VAR_4_18_AND = VAR_3_17_ROL_0 & 0xff;
