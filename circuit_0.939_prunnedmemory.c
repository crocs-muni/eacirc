...
static void circuit(unsigned char inputs[64], unsigned char outputs[2]) {
    ...
    for (int sector = 0; sector < NUM_SECTORS; sector++) {
        ...
        unsigned char VAR_1_17_XOR = VAR_IN_13 ^ 0;
        unsigned char VAR_1_18_XOR = VAR_IN_18 ^ 0;
        unsigned char VAR_2_16_OR_ = VAR_1_16_XOR | VAR_1_17_XOR | VAR_1_18_XOR | 0;
        unsigned char VAR_3_17_ROL_7 = VAR_2_16_OR_ << 7 ;
        unsigned char VAR_4_15_MUL = VAR_3_17_ROL_7 * 1;
        unsigned char VAR_4_18_DIV = ((VAR_3_17_ROL_7 != 0) ? VAR_3_17_ROL_7 : 1) / 1;
        unsigned char VAR_5_0_NOP = 0;
        unsigned char VAR_5_1_NOP = 0;
        unsigned char VAR_5_2_NOP = 0;
        unsigned char VAR_5_3_SUB = VAR_4_15_MUL - 0;
        unsigned char VAR_5_4_SUM = VAR_4_18_DIV + 0;

        VAR_IN_0 = VAR_5_0_NOP;
        VAR_IN_1 = VAR_5_1_NOP;
        VAR_IN_2 = VAR_5_2_NOP;
        outputs[0] = VAR_5_3_SUB;
