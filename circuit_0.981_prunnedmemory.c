...
static void circuit(unsigned char inputs[64], unsigned char outputs[2]) {
    ...
    for (int sector = 0; sector < NUM_SECTORS; sector++) {
        ...
        unsigned char VAR_1_17_OR_ = VAR_IN_14 | VAR_IN_17 | VAR_IN_18 | VAR_IN_7 | 0;
        unsigned char VAR_1_18_MUL = VAR_IN_18 * VAR_IN_8 * 1;
        unsigned char VAR_2_16_OR_ = VAR_1_17_OR_ | VAR_1_18_MUL | 0;
        ...
        unsigned char VAR_5_4_SUM = VAR_4_18_XOR + 0;
