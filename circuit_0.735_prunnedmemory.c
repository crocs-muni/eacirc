...
static void circuit(unsigned char inputs[64], unsigned char outputs[2]) {
    ...
    for (int sector = 0; sector < NUM_SECTORS; sector++) {
        ...
        unsigned char VAR_2_12_SUB = VAR_1_13_XOR - 0;
        ...
        unsigned char VAR_3_18_NAN = 0xff & ~  0;
        unsigned char VAR_4_12_XOR = VAR_3_13_SUM ^ 0;
        unsigned char VAR_4_16_NOP = 0;
        unsigned char VAR_4_17_ADD = VAR_3_16_SUM + VAR_3_18_NAN + 0;
        ...
        unsigned char VAR_5_4_SUB = VAR_4_16_NOP - VAR_4_17_ADD - 0;
