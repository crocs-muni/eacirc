...
void ECRYPT_HC128::ECRYPT_ivsetup(void* ctxa, const u8* iv)
{ 
	HC128_ctx* ctx = (HC128_ctx*)ctxa;
    u32 i;
...
void ECRYPT_HC128::HC128_process_bytes(
...
void ECRYPT_HC128::ECRYPT_encrypt_bytes(void* ctx, const u8 * plaintext, u8 * ciphertext, u32 msglen) {
	HC128_process_bytes(0, ctx, plaintext, ciphertext, msglen);
}
void ECRYPT_HC128::ECRYPT_decrypt_bytes(void* ctx, const u8 * ciphertext, u8 * plaintext, u32 msglen) {
