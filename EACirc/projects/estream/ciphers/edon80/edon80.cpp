...
void ECRYPT_Edon80::ECRYPT_keysetup( void* ctxa, const u8* key, u32 keysize, u32 ivsize)
{
	EDON80_ctx* ctx = (EDON80_ctx*)ctxa;
...
void ECRYPT_Edon80::ECRYPT_ivsetup(void* ctxa, const u8* iv)
{
	EDON80_ctx* ctx = (EDON80_ctx*)ctxa;
...
void ECRYPT_Edon80::ECRYPT_encrypt_bytes(void* ctxa, const u8* plaintext, u8* ciphertext, u32 msglen)
{
	EDON80_ctx* ctx = (EDON80_ctx*)ctxa;
	u32 i, j;       /* Variables i and j are internal counters. */
...
void ECRYPT_Edon80::ECRYPT_decrypt_bytes(void* ctxa, const u8* ciphertext, u8* plaintext, u32 msglen)
{
	EDON80_ctx* ctx = (EDON80_ctx*)ctxa;
	u32 i, j;       /* Variables i and j are internal counters. */
	u8 X;           /* We will store produced byte from the keystream in X. */
