...
#define STAT_CIRCUIT_INCONSISTENT               21      // CIRCUIT INCONSISTENT - UNKNOWN FUNCTIONS, UNSUPPORTED CONNECTOR MASK, ETC.
#define STAT_CIRCUIT_BACKEND_ERROR              22      // PROBLEM WITH CIRCUIT BACKEND
