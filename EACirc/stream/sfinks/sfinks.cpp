...
*/
void ECRYPT_Sfinks::ECRYPT_keysetup(
  void* ctxa, 
  const u8* key, 
...
*/
void ECRYPT_Sfinks::ECRYPT_ivsetup(
  void* ctxa, 
  const u8* iv)
{
	SFINKS_ctx* ctx = (SFINKS_ctx*)ctxa;
 ...
 */
void ECRYPT_Sfinks::SFINKS_keystream_bytes(
  SFINKS_ctx* ctx,
  u8* keystream,
 ...
 */
void ECRYPT_Sfinks::SFINKS_process_bytes(
...
void ECRYPT_Sfinks::ECRYPT_encrypt_bytes(void* ctx, const u8 * plaintext, u8 * ciphertext, u32 msglen) {
	SFINKS_process_bytes(0, ctx, plaintext, ciphertext, msglen);
}
void ECRYPT_Sfinks::ECRYPT_decrypt_bytes(void* ctx, const u8 * ciphertext, u8 * plaintext, u32 msglen) {
	SFINKS_process_bytes(1, ctx, ciphertext, plaintext, msglen);
}