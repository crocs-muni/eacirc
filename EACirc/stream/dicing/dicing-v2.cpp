...
void ECRYPT_Dicing::ECRYPT_keysetup(void* ctxa, const u8* key, u32 keysize, u32 ivsize)
{
	DICING_ctx* ctx = (DICING_ctx*)ctxa;
   int i,length;
...
void ECRYPT_Dicing::ECRYPT_ivsetup(void* ctxa, const u8* iv)
{
	DICING_ctx* ctx = (DICING_ctx*)ctxa;
...
void ECRYPT_Dicing::ECRYPT_encrypt_bytes(void* ctxa,const u8* plaintext,u8* ciphertext,u32 msglen)
{
	DICING_ctx* ctx = (DICING_ctx*)ctxa;
   u8 temp[16];
   int i;
...
void ECRYPT_Dicing::ECRYPT_decrypt_bytes(void* ctxa,const u8* ciphertext,u8* plaintext,u32 msglen)
{
	DICING_ctx* ctx = (DICING_ctx*)ctxa;
   u8 temp[16];
   int i;
