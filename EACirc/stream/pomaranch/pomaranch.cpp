...
void ECRYPT_Pomaranch::ECRYPT_keysetup(void *ctxa, const u8 *key8, u32 keysize, u32 ivsize)
{
...
void ECRYPT_Pomaranch::ECRYPT_ivsetup(void* ctxa, const u8* iv)
{
	POMARANCH_ctx* ctx = (POMARANCH_ctx*)ctxa;
...
void ECRYPT_Pomaranch::POMARANCH_process_bytes(int action, void* ctxa, const u8* input, u8* output, u32 msglen)
{
	POMARANCH_ctx* ctx = (POMARANCH_ctx*)ctxa;
	u8 JC,					/* Jump Control bit */
...
void ECRYPT_Pomaranch::ECRYPT_encrypt_bytes(void* ctx, const u8 * plaintext, u8 * ciphertext, u32 msglen) {
	POMARANCH_process_bytes(0, ctx, plaintext, ciphertext, msglen);
}
void ECRYPT_Pomaranch::ECRYPT_decrypt_bytes(void* ctx, const u8 * ciphertext, u8 * plaintext, u32 msglen) {
	POMARANCH_process_bytes(1, ctx, ciphertext, plaintext, msglen);
}