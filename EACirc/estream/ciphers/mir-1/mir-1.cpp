...
/* ------------------------------------------------------------------------- */
void ECRYPT_Mir::ECRYPT_keysetup(
           void* ctxa, 
           const u8* key, 
           u32 keysize,                /* Key size in bits. */ 
           u32 ivsize)                 /* IV size in bits. */ 
{ 
	MIR1_ctx* ctx = (MIR1_ctx*)ctxa;
  int i,j;
  for(i=0; i<256; ++i)
...
/* ------------------------------------------------------------------------- */
void ECRYPT_Mir::ECRYPT_ivsetup(
           void* ctxa, 
           const u8* IV)
{ 
	MIR1_ctx* ctx = (MIR1_ctx*)ctxa;
...
void ECRYPT_Mir::ECRYPT_encrypt_bytes(
           void* ctxa, 
           const u8* plaintext, 
           u8* ciphertext, 
...
/* ------------------------------------------------------------------------- */
void ECRYPT_Mir::ECRYPT_decrypt_bytes(
           void* ctxa, 
           const u8* ciphertext, 
           u8* plaintext, 
           u32 msglen)                /* Message length in bytes. */ 
...
/* ------------------------------------------------------------------------- */
void ECRYPT_Mir::MIR1_keystream_bytes(
           MIR1_ctx* ctx,
           u8* keystream,
