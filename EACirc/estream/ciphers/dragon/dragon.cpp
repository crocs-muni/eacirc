...
void ECRYPT_Dragon::ECRYPT_init(void)
	 ...
	 * above.
	 */
void ECRYPT_Dragon::ECRYPT_keysetup(
		ECRYPT_ctx  ctxa,
		const u8*    key,
	 ...
	 * IV's.
	 */
void ECRYPT_Dragon::ECRYPT_ivsetup(
		ECRYPT_ctx ctxa,
		const u8* iv)
	{
		u32 a, b, c, d;
	 ...
	 */
void ECRYPT_Dragon::DRAGON_keystream_blocks(
	  DRAGON_ctx* ctx,
	  u8* keystream,
	  u32 blocks)
	{
	 ...
	 */
void ECRYPT_Dragon::DRAGON_process_blocks(
	 ...
	 */
void ECRYPT_Dragon::DRAGON_keystream_bytes(
		DRAGON_ctx* ctx,
		u8* keystream,
		u32 length)
	{
...
void ECRYPT_Dragon::ECRYPT_encrypt_bytes(void* ctx, const u8 * plaintext, u8 * ciphertext, u32 msglen) {
	DRAGON_process_bytes(0, ctx, plaintext, ciphertext, msglen);
}
void ECRYPT_Dragon::ECRYPT_decrypt_bytes(void* ctx, const u8 * ciphertext, u8 * plaintext, u32 msglen) {
	DRAGON_process_bytes(1, ctx, ciphertext, plaintext, msglen);
}
	 ...
	 */
void ECRYPT_Dragon::DRAGON_process_bytes(
		int action,                 /* 0 = encrypt; 1 = decrypt; */
		ECRYPT_ctx ctxa,
		const u8* input,
		u8* output,
